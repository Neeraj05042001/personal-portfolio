...
export const BackgroundBeamsWithCollision = ({
  ...
  return (
    <div
      ...
      // original class
      // className={cn(
      //   "h-96 md:h-[30rem] bg-gradient-to-b from-white to-neutral-100 dark:from-neutral-950 dark:to-neutral-800 relative w-full overflow-hidden",
        // h-screen if you want bigger
        className={cn(
        " md:h-[38rem] relative w-full overflow-hidden border-b outline-0 border-white/90 backdrop:blur-md ",
        className
      )}>
      {beams.map((beam) => (
        <CollisionMechanism
